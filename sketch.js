...
var batAnimation,bat,maxDrops=100,drops=[];
...
function setup(){
    ...
    if(frameCount%100===0){
        for(var i=0; i<maxDrops;i++){
          drops.push(new rain(random(0,800),random(340,-10),3,10));
         }
        }
...
function draw(){
    ...
    if(frameCount%80===0){
        ...
        thunder = createSprite(random(10,770), random(10,30), 20, 20);
        switch(rand){
        ...
        thunder.scale = random(0.6,1.2)
    }
    bat= createSprite(Math.round(random(0,800)),Math.round(random(0,800)));
